{module.exports = createContributing;

const { writeFile } = require("fs").promises;

async function createContributing({ owner, repo, packageName }) {
  await writeFile(
    "CONTRIBUTING.md",
    `# How to contribute
...
- Submit a pull request from your topic branch to the master branch on the \`${owner}/${repo}\` repository.
