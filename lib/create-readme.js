...
[![Dependabot Status](https://api.dependabot.com/badges/status?host=github&repo=${repository})](https://dependabot.com/)
...
`;
  ...
  await writeFile(`README.md`, format(content, { parser: "markdown" }));
}
